...
CMD ["bash", "-c", "python3 /workspace/setup.py && python3 /comfyui/main.py --listen 0.0.0.0 --port 8188 --highvram --dont-upcast-attention & sleep 5 && python3 -u /workspace/handler.py"]
